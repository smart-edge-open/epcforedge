...
// Renamed APIClient to PolicyAuthApiClient
// Renamed ApplicationSessionsCollectionApi to PolicyAuthAppSessionApi
// Renamed EventsSubscriptionDocumentApi to PolicyAuthEventSubsApi
// Renamed IndividualApplicationSessionContextDocumentApi to PolicyAuthIndividualAppSessApi
// Renamed service to policyAuthService
// Renamed NewAPIClient to NewPolicyAuthApiClient
// PolicyAuthApiClient manages communication with the Npcf_PolicyAuthorization Service API API v1.0.1
...
func (c *PolicyAuthApiClient) callAPI(request *http.Request) (*http.Response, error) {
	if c.cfg.Debug {
...
func (c *PolicyAuthApiClient) ChangeBasePath(path string) {
	c.cfg.BasePath = path
}

// Allow modification of underlying config for alternate implementations and testing
// Caution: modifying the configuration while live can cause data races and potentially unwanted behavior
func (c *PolicyAuthApiClient) GetConfig() *Configuration {
	return c.cfg
}
*/
	...
	*/
	...
	/*
		...
		if strings.HasPrefix(headerParams["Content-Type"], "multipart/form-data") && len(formParams) > 0 || (len(fileBytes) > 0 && fileName != "") {
			if body != nil {
				return nil, errors.New("Cannot specify reqBody and multipart form at the same time.")
			}
			body = &bytes.Buffer{}
		...
		if strings.HasPrefix(headerParams["Content-Type"], "application/x-www-form-urlencoded") && len(formParams) > 0 {
			if body != nil {
				return nil, errors.New("Cannot specify reqBody and x-www-form-urlencoded form at the same time.")
			}
			body = &bytes.Buffer{}
...
func (c *PolicyAuthApiClient) decode(v interface{}, b []byte, contentType string) (err error) {
	if len(b) == 0 {
		return nil
	}
